...
class predictManager {
    ...
    func getPredict(BG0: Double, gl: Double, carbo: Double, prot: Double, t1: Double, t2: Double, t3: Double, t4: Double, kr: Double, BMI: Double) throws -> Double {
        let input = xgboost_modelInput(BG0: BG0, gl: gl, carbo: carbo, prot_b6h: prot, breakfast: t1, lunch: t2, dinner: t3, snack: t4, kr: kr, BMI: BMI)
        let config = MLModelConfiguration()
        let model = try xgboost_model(configuration: config)
