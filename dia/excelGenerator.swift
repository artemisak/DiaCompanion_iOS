...
class exportTable {
    func generate() -> URL {
        ...
        for i in 0..<tbl.count {
            ...
            for j in 0..<tbl[i].food.joined().count {
                if kk == i {
                    ...
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 65, "\(round((Double(Array(tbl[i].carbo.joined())[j])!*Double(Array(tbl[i].g.joined())[j])!/100)/100*Double(Array(tbl[i].gi.joined())[j])!*100)/100)", merge_format)
                } else {
                    ...
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 65, "\(round((Double(Array(tbl[i].carbo.joined())[j])!*Double(Array(tbl[i].g.joined())[j])!/100)/100*Double(Array(tbl[i].gi.joined())[j])!*100)/100)", merge_format_alt)
                }
                r += 1
            }
        }
        ...
        for i in 0..<tbl.count {
            ...
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 5, "\(Array(tbl[i].g.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 6, "\(Array(tbl[i].carbo.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 7, "\(Array(tbl[i].prot.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 8, "\(Array(tbl[i].fat.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 9, "\(Array(tbl[i].ec.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 10, "\(Array(tbl[i].gi.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 11, nil, nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 12, "\(Array(tbl[i].water.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 13, "\(Array(tbl[i].nzhk.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 14, "\(Array(tbl[i].hol.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 15, "\(Array(tbl[i].pv.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 16, "\(Array(tbl[i].zola.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 17, "\(Array(tbl[i].na.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 18, "\(Array(tbl[i].k.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 19, "\(Array(tbl[i].ca.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 20, "\(Array(tbl[i].mg.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 21, "\(Array(tbl[i].p.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 22, "\(Array(tbl[i].fe.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 23, "\(Array(tbl[i].a.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 24, "\(Array(tbl[i].b1.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 25, "\(Array(tbl[i].b2.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 26, "\(Array(tbl[i].rr.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 27, "\(Array(tbl[i].c.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 28, "\(Array(tbl[i].re.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 29, "\(Array(tbl[i].kar.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 30, "\(Array(tbl[i].mds.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 31, "\(Array(tbl[i].kr.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 32, "\(Array(tbl[i].te.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 33, "\(Array(tbl[i].ok.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 34, "\(Array(tbl[i].ne.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 35, "\(Array(tbl[i].zn.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 36, "\(Array(tbl[i].cu.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 37, "\(Array(tbl[i].mn.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 38, "\(Array(tbl[i].se.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 39, "\(Array(tbl[i].b5.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 40, "\(Array(tbl[i].b6.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 41, "\(Array(tbl[i].fol.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 42, "\(Array(tbl[i].b9.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 43, "\(Array(tbl[i].dfe.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 44, "\(Array(tbl[i].holin.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 45, "\(Array(tbl[i].b12.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 46, "\(Array(tbl[i].ear.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 47, "\(Array(tbl[i].a_kar.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 48, "\(Array(tbl[i].b_kript.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 49, "\(Array(tbl[i].likopin.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 50, "\(Array(tbl[i].lut_z.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 51, "\(Array(tbl[i].vit_e.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 52, "\(Array(tbl[i].vit_d.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 53, "\(Array(tbl[i].d_mezd.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 54, "\(Array(tbl[i].vit_k.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 55, "\(Array(tbl[i].mzhk.joined()).compactMap(Double.init).reduce(0,+))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 56, "\(Array(tbl[i].pzhk.joined()).compactMap(Double.init).reduce(0,+))", nil)
        }
