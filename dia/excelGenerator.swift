...
class exportTable {
    func generate(version: Int) -> URL {
        ...
        worksheet_write_string(worksheet1, 2, 35, "Цинк, в мг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 36, "Медь, в мг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 37, "Марганец,в мг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 38, "Селен, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 39, "Пантотеновая кислота, в мг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 40, "Витамин В6, в мг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 41, "Фолаты общ., в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 42, "Фолиевая кислота, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 43, "Фолаты ДФЭ, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 44, "Холин общ., в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 45, "Витамин В12, в мг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 46, "Витамин А (ЭАР), в мг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 47, "Альфа-каротин, в мгк.", merge_format3)
        worksheet_write_string(worksheet1, 2, 48, "Криптоксантин бета, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 49, "Ликопин, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 50, "Лютеин + Гексакантин, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 51, "Витамин Е, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 52, "Витамин D, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 53, "Витамин D, межд. ед.", merge_format3)
        worksheet_write_string(worksheet1, 2, 54, "Витамин К, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, 2, 55, "Мононенасыщенные жирные кислоты, в г.", merge_format3)
        worksheet_write_string(worksheet1, 2, 56, "Полиненасыщенные жирные кислоты, в г.", merge_format3)
        worksheet_write_string(worksheet1, 2, 57, nil, nil)
        worksheet_write_string(worksheet1, 2, 58, "Вес перв. ед. изм.", merge_format3)
        worksheet_write_string(worksheet1, 2, 59, "Описание перв. ед. изм.", merge_format3)
        worksheet_write_string(worksheet1, 2, 60, "Вес второй ед. изм.", merge_format3)
        worksheet_write_string(worksheet1, 2, 61, "Описание вт. ед. изм. ", merge_format3)
        worksheet_write_string(worksheet1, 2, 62, "Процент потерь, %", merge_format3)
        worksheet_write_string(worksheet1, 2, 63, nil, nil)
        worksheet_write_string(worksheet1, 2, 64, "Углеводы, в г.", merge_format3)
        worksheet_write_string(worksheet1, 2, 65, "ГН", merge_format3)
        worksheet_write_string(worksheet1, 2, 66, "УСК до еды", merge_format3)
        worksheet_write_string(worksheet1, 2, 67, "Прогноз УСК", merge_format3)
        worksheet_write_string(worksheet1, 2, 68, "Время добавления записи", merge_format3)
        ...
        for i in 0..<tbl.count {
            ...
            for i1 in 0..<tbl[i].time.count {
                ...
                if kk == i {
                    ...
                    worksheet_write_string(worksheet1, lxw_row_t(r1+3), 67, "\(round(Double(tbl[i].BG1[i1])!*100)/100)", merge_format1)
                    ...
                    worksheet_write_string(worksheet1, lxw_row_t(r1+3), 67, "\(round(Double(tbl[i].BG1[i1])!*100)/100)", merge_format_alt1)
            ...
            for j in 0..<tbl[i].food.joined().count {
                if kk == i {
                    ...
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 35, Array(tbl[i].zn.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 36, Array(tbl[i].cu.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 37, Array(tbl[i].mn.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 38, Array(tbl[i].se.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 39, Array(tbl[i].b5.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 40, Array(tbl[i].b6.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 41, Array(tbl[i].fol.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 42, Array(tbl[i].b9.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 43, Array(tbl[i].dfe.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 44, Array(tbl[i].holin.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 45, Array(tbl[i].b12.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 46, Array(tbl[i].ear.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 47, Array(tbl[i].a_kar.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 48, Array(tbl[i].b_kript.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 49, Array(tbl[i].likopin.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 50, Array(tbl[i].lut_z.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 51, Array(tbl[i].vit_e.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 52, Array(tbl[i].vit_d.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 53, Array(tbl[i].d_mezd.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 54, Array(tbl[i].vit_k.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 55, Array(tbl[i].mzhk.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 56, Array(tbl[i].pzhk.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 57, nil, nil)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 58, Array(tbl[i].w_1ed.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 59, Array(tbl[i].op_1ed.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 60, Array(tbl[i].w_2ed.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 61, Array(tbl[i].op_2ed.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 62, Array(tbl[i].proc_prot.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 63, nil, nil)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 64, Array(tbl[i].carbo.joined())[j], merge_format)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 65, "\(round((Double(Array(tbl[i].carbo.joined())[j])!*Double(Array(tbl[i].g.joined())[j])!/100)*Double(Array(tbl[i].gi.joined())[j])!)/100)", merge_format)
                } else {
                    ...
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 35, Array(tbl[i].zn.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 36, Array(tbl[i].cu.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 37, Array(tbl[i].mn.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 38, Array(tbl[i].se.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 39, Array(tbl[i].b5.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 40, Array(tbl[i].b6.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 41, Array(tbl[i].fol.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 42, Array(tbl[i].b9.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 43, Array(tbl[i].dfe.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 44, Array(tbl[i].holin.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 45, Array(tbl[i].b12.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 46, Array(tbl[i].ear.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 47, Array(tbl[i].a_kar.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 48, Array(tbl[i].b_kript.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 49, Array(tbl[i].likopin.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 50, Array(tbl[i].lut_z.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 51, Array(tbl[i].vit_e.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 52, Array(tbl[i].vit_d.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 53, Array(tbl[i].d_mezd.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 54, Array(tbl[i].vit_k.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 55, Array(tbl[i].mzhk.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 56, Array(tbl[i].pzhk.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 57, nil, nil)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 58, Array(tbl[i].w_1ed.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 59, Array(tbl[i].op_1ed.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 60, Array(tbl[i].w_2ed.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 61, Array(tbl[i].op_2ed.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 62, Array(tbl[i].proc_prot.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 63, nil, nil)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 64, Array(tbl[i].carbo.joined())[j], merge_format_alt)
                    worksheet_write_string(worksheet1, lxw_row_t(r+3), 65, "\(round((Double(Array(tbl[i].carbo.joined())[j])!*Double(Array(tbl[i].g.joined())[j])!/100)*Double(Array(tbl[i].gi.joined())[j])!)/100)", merge_format_alt)
                }
                r += 1
            }
        }
        ...
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 35, "Цинк, в мг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 36, "Медь, в мг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 37, "Марганец,в мг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 38, "Селен, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 39, "Пантотеновая кислота, в мг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 40, "Витамин В6, в мг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 41, "Фолаты общ., в мкг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 42, "Фолиевая кислота, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 43, "Фолаты ДФЭ, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 44, "Холин общ., в мкг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 45, "Витамин В12, в мг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 46, "Витамин А (ЭАР), в мг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 47, "Альфа-каротин, в мгк.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 48, "Криптоксантин бета, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 49, "Ликопин, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 50, "Лютеин + Гексакантин, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 51, "Витамин Е, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 52, "Витамин D, в мкг.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 53, "Витамин D, межд. ед.", merge_format3)
        worksheet_write_string(worksheet1, lxw_row_t(3+r1+2), 54, "Витамин К, в мкг.", merge_format3)
        ...
        for i in 0..<tbl.count {
            ...
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 10, "\(computeGI(gi: Array(tbl[i].gi.joined()).compactMap(Double.init), carbo: Array(tbl[i].carbo.joined()).compactMap(Double.init)))", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 11, nil, nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 12, "\(round(Array(tbl[i].water.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 13, "\(round(Array(tbl[i].nzhk.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 14, "\(round(Array(tbl[i].hol.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 15, "\(round(Array(tbl[i].pv.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 16, "\(round(Array(tbl[i].zola.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 17, "\(round(Array(tbl[i].na.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 18, "\(round(Array(tbl[i].k.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 19, "\(round(Array(tbl[i].ca.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 20, "\(round(Array(tbl[i].mg.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 21, "\(round(Array(tbl[i].p.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 22, "\(round(Array(tbl[i].fe.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 23, "\(round(Array(tbl[i].a.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 24, "\(round(Array(tbl[i].b1.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 25, "\(round(Array(tbl[i].b2.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 26, "\(round(Array(tbl[i].rr.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 27, "\(round(Array(tbl[i].c.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 28, "\(round(Array(tbl[i].re.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 29, "\(round(Array(tbl[i].kar.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 30, "\(round(Array(tbl[i].mds.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 31, "\(round(Array(tbl[i].kr.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 32, "\(round(Array(tbl[i].te.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 33, "\(round(Array(tbl[i].ok.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 34, "\(round(Array(tbl[i].ne.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 35, "\(round(Array(tbl[i].zn.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 36, "\(round(Array(tbl[i].cu.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 37, "\(round(Array(tbl[i].mn.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 38, "\(round(Array(tbl[i].se.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 39, "\(round(Array(tbl[i].b5.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 40, "\(round(Array(tbl[i].b6.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 41, "\(round(Array(tbl[i].fol.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 42, "\(round(Array(tbl[i].b9.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 43, "\(round(Array(tbl[i].dfe.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 44, "\(round(Array(tbl[i].holin.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 45, "\(round(Array(tbl[i].b12.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 46, "\(round(Array(tbl[i].ear.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 47, "\(round(Array(tbl[i].a_kar.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 48, "\(round(Array(tbl[i].b_kript.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 49, "\(round(Array(tbl[i].likopin.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 50, "\(round(Array(tbl[i].lut_z.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 51, "\(round(Array(tbl[i].vit_e.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 52, "\(round(Array(tbl[i].vit_d.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 53, "\(round(Array(tbl[i].d_mezd.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 54, "\(round(Array(tbl[i].vit_k.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 55, "\(round(Array(tbl[i].mzhk.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
            worksheet_write_string(worksheet1, lxw_row_t(3+r1+3+i), 56, "\(round(Array(tbl[i].pzhk.joined()).compactMap(Double.init).reduce(0,+)*100)/100)", nil)
        }
