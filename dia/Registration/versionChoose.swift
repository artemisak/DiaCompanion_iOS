        ...
        GeometryReader {g in
            ScrollView{
                ...
                VStack{
                    Button(action: {
                        Task {
                            await loginManager.setChoosed(number: 1)
                        }
                    }) {
                    ...
                    Button(action: {
                        Task {
                            await loginManager.setChoosed(number: 2)
                        }
                    }) {
                    ...
                    Button(action: {
                        Task {
                            await loginManager.setChoosed(number: 3)
                        }
                    }) {
                    ...
                    Button(action: {
                        Task {
                            await loginManager.setChoosed(number: 4)
                        }
                    }) {
