...
struct aboutApp: View {
    var body: some View {
        List {
            ...
            Section {
                Text("Производитель: ФГБУ «НМИЦ им. В.А. Алмазова» Минздрава России. Юридическое лицо зарегистрировано по адресу: Россия, г. Санкт-Петербург, ул. Аккуратова, д. 2., 197341.")
            } header: {
