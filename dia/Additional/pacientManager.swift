...
class pacientViewModel: ObservableObject {
    ...
    init() {
        do {
            ...
            var patient_week = 22
            var patient_day = 3
            var patient_weight = 60.0
            var patient_height = 175.0
            ...
            print(error)
            self.woman = Person(fio: "", birthday: Date(), selectedDoc: .Anopova, start_date: Date(), week_of_start: 22, day_of_start: 3,  patientID: 1, weight: 60.0, height: 175.0)
        }
    }
}
